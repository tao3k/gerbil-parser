...
`:gerbil-parser/rust-rowan-support` facade, proves deterministic output, then
compiles and tests this standalone Cargo consumer. The fixture never imports a
private Rust engine module and never implements a Rowan sink.
